...
const ClientDashboard = () => {
    ...
    useEffect(() => {
        const load = async () => {
            try {
                const res = await fetchAvailability(freelancerId);
                // Only show open (not booked) slots
                setAvailability((res.data || []).filter(s => !s.is_booked));
            } catch {
        ...
        <>
            ...
            <div className="cd-root">
                <div className="cd-inner">
                    ...
                    <div className="cd-heading">Book an appointment</div>
                    <div className="cd-sub">Select an available time slot below</div>
